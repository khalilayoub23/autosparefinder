...
class TestDecode(unittest.TestCase):
    ...
    def tearDownClass(cls):
        cls.code128 = cls.code128_null_character = cls.qrcode = cls.qrcode_rotated = (
            cls.empty
        ) = None
    ...
    def test_external_dependencies(self):
        ...
        if "Windows" == platform.system():
            ...
            self.assertTrue(any("libiconv" in d._name for d in EXTERNAL_DEPENDENCIES))
        self.assertTrue(any("libzbar" in d._name for d in EXTERNAL_DEPENDENCIES))
