...
const steps = [
  {
    ...
    title: "Search",
    desc: "Find parts by VIN, OEM, SKU or vehicle details."
  },
  {
    icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
    title: "Compare",
    desc: "Compare prices, condition, delivery & suppliers."
  },
  {
    icon: "M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z",
    title: "Order or Quote",
    desc: "Place an order or request a quote if stock is limited."
  },
  {
    icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z",
    title: "Track & Receive",
    desc: "Track your order and get support anytime."
  }
]
...
export default function LandingPage() {
  ...
  /* hero search */
  const [activeTab, setActiveTab] = useState(heroTabs[0].name)
  ...
  const handleHeroSearch = () => {
    ...
    if (!q) return
    const mode = activeTab === "Search by VIN" ? "vin"
      : activeTab === "OEM Number" ? "oem"
      : activeTab === "SKU / Part Number" ? "sku"
      : "vehicle"
    navigate(`/parts?search=${encodeURIComponent(q)}&mode=${mode}`)
  }

  return (
    <div className="min-h-screen bg-[#f4f7fd] text-slate-900 font-sans" style={{ direction: 'ltr', textAlign: 'left' }}>
        ...
        <div className="border-b border-white/10 text-[12px] text-slate-300 bg-[#080e1c]">
          <div className="max-w-[1400px] mx-auto px-4 py-2.5 flex md:items-center flex-col md:flex-row justify-between gap-3">
            ...
            <div className="flex items-center gap-6 font-medium">
              ...
              <details className="relative" aria-label="Currency selector">
                <summary className="list-none cursor-pointer flex items-center gap-1.5 rounded-md border border-white/10 px-2 py-1 hover:bg-white/10 transition-colors">
                  <img src="https://flagcdn.com/w20/us.png" alt="USD" className="w-4 h-auto rounded-sm" />
                  <span className="text-[12px] font-semibold text-slate-200">USD</span>
                ...
                <div className="absolute right-0 mt-2 w-36 rounded-md border border-white/15 bg-[#021737] shadow-lg overflow-hidden z-20">
                  <a href="?lang=he" className="flex items-center gap-2 px-2.5 py-1.5 text-[12px] hover:bg-white/10 transition-colors">
                    <img src="https://flagcdn.com/w20/il.png" alt="Hebrew" className="w-4 h-auto rounded-sm" />
                    <span>Hebrew</span>
                  </a>
                  <a href="?lang=ar" className="flex items-center gap-2 px-2.5 py-1.5 text-[12px] hover:bg-white/10 transition-colors">
                    <img src="https://flagcdn.com/w20/sa.png" alt="Arabic" className="w-4 h-auto rounded-sm" />
                    <span>Arabic</span>
                  </a>
                  <a href="?lang=en" className="flex items-center gap-2 px-2.5 py-1.5 text-[12px] hover:bg-white/10 transition-colors">
        ...
        <div className="max-w-[1400px] mx-auto px-4 py-2.5 md:py-3 flex items-center justify-between gap-4 md:gap-5">
          ...
          <div className="hidden lg:flex items-center gap-4 text-[13px] font-medium text-slate-100 flex-shrink-0">
            ...
            <a href={user ? "/account" : "/login"} className="flex items-center gap-3 cursor-pointer hover:text-white transition-colors group">
              ...
              <div className="flex flex-col leading-tight">
                <span className="font-bold">{user ? "My Account" : "Sign In"}</span>
                <span className="text-[12px] text-slate-400">{user ? user.email?.split('@')[0] : "My Account"}</span>
              </div>
            </a>
            <a href="/cart" className="flex items-center gap-3 cursor-pointer hover:text-white transition-colors group relative">
              <div className="relative">
                ...
                <div className="absolute -top-1.5 -right-2 bg-[#2563eb] text-white text-[11px] w-5 h-5 rounded-full flex items-center justify-center font-bold shadow-sm">{cartCount > 99 ? '99+' : cartCount}</div>
              </div>
      ...
      <section className="bg-[#070e1d] relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-[10%] right-[-5%] w-[65%] max-w-[900px] h-full bg-[radial-gradient(ellipse_at_center,rgba(37,99,235,0.18),transparent_55%)] pointer-events-none"></div>
        </div>
              ...
              <div className="mt-8 rounded-2xl border border-white/5 bg-[#0a1e3f]/60 p-4 lg:p-5 shadow-2xl backdrop-blur-md">
                ...
                <div className="flex flex-col sm:flex-row gap-0 rounded-xl overflow-hidden bg-white shadow-inner focus-within:ring-2 focus-within:ring-[#3b82f6] transition-shadow mt-2 relative">
                  ...
                  <input
                    ...
                    className="flex-1 pl-12 pr-4 py-4 md:text-[15px] text-slate-800 outline-none w-full font-medium"
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid lg:grid-cols-[280px_1fr] gap-10">
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute left-[19px] top-6 bottom-6 w-px border-l-2 border-dashed border-slate-200"></div>
                  ...
                  {steps.map((step, idx) => (
                    <div key={step.title} className="flex items-start gap-3 relative z-10">
                      ...
                      <div className="pt-0.5">
                        <p className="font-bold text-[15px] text-[#021737] mb-0.5">{step.title}</p>
                        <p className="text-[13px] text-slate-500 leading-snug pr-4">{step.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div id="categories">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                {categories.map(([name, count, image, isMore]) => (
                  <article key={name} className="group cursor-pointer" onClick={() => navigate('/parts')}>
                    <div className="h-full rounded-xl border border-slate-100 bg-white p-3 shadow hover:shadow-lg transition-all duration-300 hover:border-[#2563eb]/40 hover:-translate-y-0.5 flex flex-col items-center justify-center text-center">
                      ...
                      <p className="text-[11px] text-slate-500 mt-0.5">{count}</p>
                    </div>
                  </article>
                ))}
              </div>
          ...
          <div className="mt-12 flex flex-col lg:flex-row gap-4">
            ...
            <div className="lg:w-[65%] grid sm:grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ["Parts Compatibility", "Guaranteed fit for your vehicle.", "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"],
                ...
                ["Global Shipping", "We ship worldwide to most countries.", "M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"],
                ["Easy Returns", "Hassle-free returns within 30 days.", "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"]
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-[13px] text-slate-400 leading-relaxed max-w-xs">
                Your global marketplace for auto parts. Millions of parts, thousands of suppliers, one platform.
              </p>
            </div>
            <div>
              <h4 className="font-bold text-[14px] mb-4 text-slate-200">Quick Links</h4>
              <ul className="space-y-2 text-[13px] text-slate-400">
                <li><a href="/parts" className="hover:text-white transition-colors">Browse Parts Catalog</a></li>
            ...
            <div>
              <h4 className="font-bold text-[14px] mb-4 text-slate-200">Support</h4>
              <ul className="space-y-2 text-[13px] text-slate-400">
                <li><a href="https://wa.me/972532426920" target="_blank" rel="noreferrer" className="hover:text-white transition-colors flex items-center gap-1.5"><WhatsAppIcon className="w-3.5 h-3.5" /> WhatsApp Support</a></li>
                <li><a href="/chat" className="hover:text-white transition-colors">Live AI Chat</a></li>
                <li><a href="/privacy" className="hover:text-white transition-colors">Privacy Policy</a></li>
                <li><a href="/terms" className="hover:text-white transition-colors">Terms of Use</a></li>
                <li><a href="/refund" className="hover:text-white transition-colors">Returns & Refunds</a></li>
              </ul>
            </div>
          </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.45)] hover:shadow-[0_6px_28px_rgba(37,211,102,0.6)] hover:scale-110 transition-all duration-200"
      >
