...
PART_TYPE_FAMILIES: Tuple[PartTypeFamily, ...] = (
    ...
    PartTypeFamily(
        ...
        keywords=("timing belt", "drive belt", "serpentine belt", "v-belt", "fan belt", "chain", "timing chain", "idler", "tensioner", "רצועת תזמון", "רצועה", "שרשרת", "מותחן"),
        subcategories=(
    ...
    PartTypeFamily(
        ...
        keywords=("service", "maintenance", "repair kit", "kit", "general", "bolt", "nut", "screw", "clip", "stud", "setscrew", "o-ring", "seal", "gasket", "retainer", "shim", "washer", "grommet", "pin", "spring clip", "circlip", "כללי", "ערכת תיקון", "ברגים", "אטמים", "בורג", "אום", "ברג", "שייבה", "מהדק", "פין", "קליפס", "גומי", "טבעת"),
        subcategories=(
    ...
    PartTypeFamily(
        ...
        keywords=("clutch", "flywheel", "axle", "drive shaft", "propshaft", "halfshaft", "half shaft", "half-shaft", "cv joint", "final drive", "driveline", "קלאץ", "גל הינע", "ציריה", "פעמון", "חצי ציר"),
        subcategories=(
    ...
    PartTypeFamily(
        ...
        keywords=("gearbox", "transmission", "gear", "differential", "torque converter", "synchromesh", "synch", "seal kit", "ממיר מומנט", "גיר", "תמסורת", "דיפרנציאל"),
        subcategories=(
    ...
    PartTypeFamily(
        ...
        keywords=("suspension", "steering", "shock", "strut", "arm", "tie rod", "rack", "sway bar", "stabilizer bar", "anti-roll", "subframe", "crossmember", "bushing", "ball joint", "bush", "בולם", "תפוח", "זרוע", "מסרק", "הגה", "מייצב", "בוש", "בושינג", "מוט מייצב"),
        subcategories=(
    ...
    PartTypeFamily(
        ...
        keywords=("body", "bumper", "grille", "door", "hood", "mirror", "fender", "moulding", "finisher", "bezel", "treadplate", "casing", "cover", "undertray", "heatshield", "insulator", "reinforcement", "badge", "panel", "trim panel", "diffuser", "skirt", "spoiler lip", "sill", "arch", "wheelarch", "rocker", "paraurti", "מרכב", "פגוש", "גריל", "מראה", "כנף", "תושבת", "בית", "דיפיוזר", "סף", "ספוילר שפה"),
        subcategories=(
    ...
    PartTypeFamily(
        ...
        keywords=("ac", "a/c", "compressor", "condenser", "blower", "heater", "climate", "dryer", "receiver dryer", "drier", "accumulator", "evaporator", "heater core", "orifice tube", "מזגן", "מדחס", "מעבה", "חימום", "מיכל מייבש", "מאייד", "אידוי", "תנור"),
        subcategories=(
    ...
    PartTypeFamily(
        ...
        aliases=("safety", "airbag", "seatbelt", "מערכת בטיחות", "בטיחות"),
        legacy_categories=("מערכת בטיחות",),
        keywords=("airbag", "air bag", "srs module", "srs", "seatbelt", "seat belt", "safety belt", "pretensioner", "crash sensor", "impact sensor", "roll bar", "rollbar", "air bag module", "כרית אוויר", "אייר בג", "חגורה", "חגורת בטיחות", "חיישן התנגשות", "בטיחות"),
        subcategories=(
            PartSubcategory("airbags", "Airbags", aliases=("airbag", "כרית אוויר", "אייר בג")),
            PartSubcategory("seatbelts", "Seatbelts", aliases=("seatbelt", "seat belt", "חגורה")),
            PartSubcategory("crash-sensors", "Crash Sensors", aliases=("crash sensor", "חיישן התנגשות")),
        ),
    ),
    PartTypeFamily(
        id="hybrid-ev",
        label="Hybrid & EV",
        group_id="hybrid-ev",
        group_label="Hybrid & EV",
        badge="EV",
        icon_key="electric",
        palette=("#16a34a", "#86efac"),
        aliases=("hybrid", "electric", "ev", "hev", "בטריה", "מערכת היברידית", "מערכת חשמלית"),
        legacy_categories=("מערכת היברידית וחשמלי",),
        keywords=("hybrid", "electric motor", "inverter", "pdu", "hv battery", "traction battery", "regenerative", "bms", "ev", "היברידי", "מנוע חשמלי", "ממיר מתח", "סוללת רכב", "בטריה"),
        subcategories=(
            PartSubcategory("hv-batteries", "HV Batteries", aliases=("hv battery", "סוללה גדולה")),
            PartSubcategory("ev-motors", "EV Motors", aliases=("electric motor", "מנוע חשמלי")),
            PartSubcategory("inverters-pdu", "Inverters & PDU", aliases=("inverter", "pdu", "ממיר")),
        ),
    ),
    PartTypeFamily(
        id="interior-comfort",
        ...
        keywords=("interior", "seat", "headrest", "squab", "cushion", "bolster", "armrest", "headlining", "sunvisor", "glovebox", "console", "dashboard", "trim", "window switch", "cargo mat", "boot liner", "cargo liner", "trunk mat", "parcel shelf", "ריפוד", "מושב", "דשבורד", "פנים", "ידית", "משענת", "מגן תא מטען", "מגש מטען", "לוילון"),
        subcategories=(
