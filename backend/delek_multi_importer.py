...
Run inside backend container:
    docker exec autospare_backend python /app/delek_multi_importer.py           # all brands
    docker exec autospare_backend python /app/delek_multi_importer.py --brands 3,6   # BMW + NIO
    docker exec autospare_backend python /app/delek_multi_importer.py --brands 2,4,7,8  # Ford+MAXUS+Voyah
