...
CATEGORY_MAP = {
    'בלמים': {
        'he': ['בלם', 'בלמים', 'רפידה', 'רפידות', 'דיסק', 'דיסקים', 'קליפר', 'קליפרים', 'תוף', 'תופים', 'בוסטר', 'צלחת', 'צלחות', 'רפידת', 'ברקס', 'ברקסים'],
    ...
    'מנוע': {
        'he': ['מנוע', 'בוכנה', 'בוכנות', 'שסתום', 'שסתומים', 'גל ארכובה', 'גל זיזים', 'בוקסה', 'תושבת מנוע', 'ראש מנוע', 'אגן שמן'],
        'en': ['engine', 'piston', 'valve', 'crankshaft', 'camshaft', 'block', 'mount', 'gasket']
    },
    'קירור': {
    ...
    'חשמל ואלקטרוניקה': {
        'he': ['אלטרנטור', 'מצת הנעה', 'ECU', 'מחשב', 'ממסר', 'פיוז', 'צמת', 'סטרטר', 'צמה', 'יוניט', 'סליל'],
        'en': ['alternator', 'starter motor', 'ecu', 'relay', 'fuse', 'wiring', 'starter', 'unit', 'coil']
    },
    'חיישנים': {
    ...
    'אטמים וצינורות': {
        'he': ['אטם', 'אטמים', 'גיממה', 'אוילים', 'צינור', 'צינורות', 'מחזיר שמן', 'שייבה', 'גומיות', 'גומי'],
        'en': ['gasket', 'seal', 'o-ring', 'head gasket', 'hose', 'pipe', 'oil seal', 'rubber']
    },
    'מערכת בטיחות': {
