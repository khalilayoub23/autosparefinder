...
Usage:
  docker exec autospare_backend python3 /app/importers/colmobil_import_v2.py
  docker exec autospare_backend python3 /app/importers/colmobil_import_v2.py --brands hyundai,mitsubishi
"""
